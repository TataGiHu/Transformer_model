...
DPIPELINES = Registry('dpipelines')
DATAPROVIDERS = Registry('data_providers')

def bulid_dataset(cfg):
    return build_from_cfg(cfg, DATASETS)

def build_data_provider(cfg):
    return build_from_cfg(cfg, DATAPROVIDERS)
